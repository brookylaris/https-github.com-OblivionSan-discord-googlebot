...
exports.run = (client, message) => {
	if (message.content === `${p}help`, message) {
		let embed = new Discord.RichEmbed()
			.setAuthor("RageStat Bot's Command List", client.user.displayAvatarURL)
			.setDescription("RageStatBot developed by [**rissy#0666**](https://discord.gg/exEBTMA) | [**Support Server**] (https://discord.gg/exEBTMA)")
			.setColor(`#ffffff`)
